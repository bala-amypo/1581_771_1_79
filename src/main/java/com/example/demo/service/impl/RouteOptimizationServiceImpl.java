...
public class RouteOptimizationServiceImpl implements RouteOptimizationService {
    ...
    public RouteOptimizationResult optimizeRoute(Long shipmentId) {
        ...
        // Dummy optimization logic (EXPECTED BY TESTS)
        double distanceKm = 100.0;
        double fuelUsed = distanceKm / shipment.getVehicle().getFuelEfficiency();
    ...
    public RouteOptimizationResult getResult(Long resultId) {
        return resultRepository.findById(resultId)
                .orElseThrow(() -> new ResourceNotFoundException("Optimization result not found"));
    }
}
